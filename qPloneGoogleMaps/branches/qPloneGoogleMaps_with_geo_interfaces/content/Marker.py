...
class Marker(ATDocument):
    ...
    name = property(""" see interface """)
    visibility = property(""" see interface """)
    open = property(""" see interface """)
    address = property(""" see interface """)
    AddressDetails = property(""" see interface """)
    phoneNumber = property(""" see interface """)
    Snippet = property(""" see interface """)
    LookAt = property(""" see interface """)
    StyleSelector = property(""" see interface """)
    Region = property(""" see interface """)
    geometry = property(""" see interface """)
