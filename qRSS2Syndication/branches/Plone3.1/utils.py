...
def setupRSS2Types(context,
    ...
    if syInfo is None:
        ...
        syInfo.max_items = articles_number
...
def getRSS2Properties(context):
     ...
     syPropeties['enable_itunes'] = getattr(syInfo,'enable_itunes',0)
     syPropeties['itunes_image_url'] = getattr(syInfo,'itunes_image_url','')
     syPropeties['itunes_explicit'] = getattr(syInfo,'itunes_explicit',0)
     return  syPropeties
