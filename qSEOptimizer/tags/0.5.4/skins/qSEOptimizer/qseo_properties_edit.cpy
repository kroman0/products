...
##parameters=title=None,description=None,keywords=None,html_comment=None,robots=None,distribution=None,ecma_script=None,title_override=0,description_override=0,keywords_override=0,html_comment_override=0,robots_override=0,distribution_override=0,ecma_override=0
...
setProperty(context, 'qSEO_ecma_script', ecma_script)
...
if not ecma_override:         delete_list.append('qSEO_ecma_script')
