...
def parseCSV(self, data):
    ...
    from Products.qMemberdataExport import PASMemberdataHandler, CMFMemberdataHandler, BaseMemberdataHandler
    ...
    if datahandler:
        ...
        if pas_installed:
            self.assertEquals(datahandler.__class__, PASMemberdataHandler)
        elif cmfmember_installed:
