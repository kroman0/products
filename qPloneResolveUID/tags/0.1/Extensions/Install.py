...
def unregisterTransformPolicy(self, out, output_mimetype):
    transforms = getToolByName(self, 'portal_transforms')
    transforms.manage_delPolicies(self, output_mimetype)
    print >> out, "Removed transform policy for %s mimetype" %output_mimetype
