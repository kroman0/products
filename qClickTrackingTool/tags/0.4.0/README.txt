...
Usage
  ...
  3. Create your Campaigns there. Important are id (campaign Id) and 
  ...
  4. Add following section to your awstats.*config*.conf::
     ...
     If you have ExtraSection 1 in your config, change 1 in the lines aove 
     to next available number.
...
Upgrading
  ...
  The tool detects older versions installed and applies migration procedure 
  upon reinstallation. Do not Uninstall product, Reinstall it to preserve\
  Campaigns created in previos versions of product.
