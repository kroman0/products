...
from Products.RPCAuth.RPCAuth import manage_addRPCAuth
...
def addRPCAuth(self, out):
    """ Add RPC Auth object to the root of the site.
    """
    portal = getToolByName(self, 'portal_url').getPortalObject()
    rpcauth = getToolByName(portal, 'RPCAuth', None)
    if rpcauth is None:
        manage_addRPCAuth(portal,'RPCAuth')
        print >>out, 'Installing RPC Auth'
    else:
        print >>out, 'RPC Auth already installed'
