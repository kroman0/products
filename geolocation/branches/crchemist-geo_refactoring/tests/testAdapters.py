...
class TestGEOLocatedAdapter(PloneTestCase.PloneTestCase):
    ...
    def afterSetUp(self):
        ...
        self.adapter = IPoint(self.page)
        self.adapter.coordinates = (LONGITUDE, LATITUDE, ALTITUDE)

    def testImplementation(self):
        """ Test adapter implementation """
        IPoint.implementedBy(Point)

    def testGetters(self):
        """ Test adapters' getters """
        self.failUnlessEqual(self.adapter.coordinates[0], LONGITUDE)
        self.failUnlessEqual(self.adapter.coordinates[1], LATITUDE)
        self.failUnlessEqual(self.adapter.coordinates[2], ALTITUDE)
