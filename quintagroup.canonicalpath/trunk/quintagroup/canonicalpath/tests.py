...
class TestIndexerRegistration(TestCase):
    ...
    def testForAT(self):
        ...
        self.assertFalse(wrapper is None,
                         "No indexer registered for document object")
...
class TestConvertor(unittest.TestCase):
    ...
    def test_convertBadItems(self):
        ...
        expect = "NotPropertyProviderItem instance "\
                 "has no attribute 'hasProperty'"
...
class TestAdaptersRegistration(unittest.TestCase):
    ...
    def test_PropertyManagerAndTraversable(self):
        class ProperyAndTraverseProvider(BaseItem, PropertyManager,
                                         Traversable):
